...
_(Note: "Conceptual/Future" indicates features described in the main project README that may not be fully implemented in the current core version. Always refer to the latest `TODO.md` or main project `README.md` for current feature status.)_
